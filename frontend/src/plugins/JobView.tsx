        ...
        <div className="glass-card rounded-[12px] p-8 border border-black/5 dark:border-white/5 bg-gradient-to-br from-[var(--accent)]/10 to-transparent relative overflow-hidden group">
          <div className="relative z-10">
            <div className="flex items-center space-x-3 mb-4">
              <div className="px-2 py-1 bg-[var(--success)]/20 text-[var(--success)] text-[9px] font-bold uppercase tracking-widest rounded-[2px]">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="flex items-center px-8 py-3 btn-accent rounded-[4px] text-xs font-bold hover:bg-[var(--accent-hover)] transition-all shadow-lg shadow-[var(--accent)]/20 uppercase tracking-widest"
              >
          ...
          <div className="absolute right-[-10%] top-1/2 -translate-y-1/2 opacity-10 group-hover:opacity-20 transition-opacity">
            <Mic className="w-64 h-64 text-[var(--accent)]" />
          </div>
        </div>
      </section>
    </div>
  ...
  return (
    <div className="flex-1 flex flex-col p-8">
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto w-full text-center">
        {step === 'intro' && (
          <div>
            <div className="w-20 h-20 bg-[var(--accent)]/10 rounded-full flex items-center justify-center mb-8 mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 mb-12">
              <div className="p-4 bg-black/2 dark:bg-white/2 border border-black/5 dark:border-white/5 rounded-[4px] text-left">
                ...
                <p className="text-xs text-[var(--text-secondary)]">{t.job_metricsDesc}</p>
              </div>
              <div className="p-4 bg-black/2 dark:bg-white/2 border border-black/5 dark:border-white/5 rounded-[4px] text-left">
                <p className="text-[10px] font-bold text-[var(--text-secondary)] uppercase mb-1">{t.job_duration}</p>
                <p className="text-xs text-[var(--text-secondary)]">{t.job_durationDesc}</p>
              </div>
            </div>
            ...
            <button
              ...
              className="px-12 py-4 btn-accent rounded-[4px] text-xs font-bold hover:bg-[var(--accent-hover)] transition-all shadow-xl shadow-[var(--accent)]/20 uppercase tracking-widest"
            >
        ...
        {step === 'session' && (
          <div className="w-full">
            <div className="w-32 h-32 relative mx-auto mb-12">
              <div className="absolute inset-0 bg-[var(--accent)] opacity-20 rounded-full animate-ping" />
        ...
        {step === 'feedback' && (
          <div className="w-full text-left">
            ...
            <div className="glass-card rounded-[8px] p-6 border border-black/5 dark:border-white/5 bg-black/2 dark:bg-white/2 mb-12">
              ...
              <p className="text-[var(--text-secondary)] text-sm italic leading-relaxed">{t.job_feedbackSample}</p>
            </div>
